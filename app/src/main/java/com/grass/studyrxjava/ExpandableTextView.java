...
public class ExpandableTextView extends TextView {
    ...
    public static final int EXPAND_OFFET = 0;
...
//            setOnClickListener(mExpandableClickListener);
    ...
    private CharSequence getNewTextByConfig() {
        ...
        switch (mCurrState) {
            case STATE_SHRINK: {
                Log.i("grass", "state shrink is working");
                ...
                Log.i("grass", "indexStart: " + indexStart + " indexEnd: " + indexEnd);
                Log.i("grass", "mEllipsisHint: " + mEllipsisHint + " mShowToExpandHint: " + mShowToExpandHint + " mToExpandHint: " + mToExpandHint
                        + " mGapToExpandHint: " + mGapToExpandHint);
                int indexEndTrimmed = indexEnd
                        - getLengthOfString(mEllipsisHint)
                        - (mShowToExpandHint ? getLengthOfString(mToExpandHint) + getLengthOfString(mGapToExpandHint) : 0) + EXPAND_OFFET;
                ...
                float widthTailReplaced = mTextPaint.measureText(getContentOfString(mEllipsisHint)
                        + (mShowToExpandHint ? (getContentOfString(mToExpandHint) + getContentOfString(mGapToExpandHint)) : "") + EXPAND_OFFET);
            ...
            case STATE_EXPAND: {
                Log.i("grass", "state expand is working");
        ...
        Log.i("grass", "getTextByConfig cost: " + (System.currentTimeMillis() - start));
        return mOrigText;
    }
